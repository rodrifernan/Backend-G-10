...
const productMockUp = async () => {
  try {
    ...
    await Product.create({
      id: '4841011e-fbf5-4c92-a770-3b06684f5896',
    ...
    await Product.create({
      id: '5b7122b7-8134-41ac-8cad-36bec8d9f0f8',
      name: 'Cejas postizas',
      price: 500,
      // newItem: false,
      brand: 'Generico',
    ...
    await Product.create({
      id: 'ec921f90-048e-4477-9112-db8a5666976b',
    ...
    await Product.create({
      id: 'b2d8f1c1-c7cf-49c7-8b77-73f0562809e0',
