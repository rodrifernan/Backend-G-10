...
const productMockUp = async () => {
  try {
    ...
    await Product.create({
      ...
      reviewsId  : '69cacb3c-4ef3-4d72-bbf3-d6618e890001',
    ...
    await Product.create({
      ...
      reviewsId  : '69cacb3c-4ef3-4d72-bbf3-d6618e800001',
      genreId   : '69cacb3c-4ef3-4d72-bbf3-d6618e450001',
    });
    ...
    await Product.create({
      ...
      // brand: 1,
      categoryId: '62cacb3c-4ef3-4d72-bbf3-d6618e45a481',
      reviewsId : '69cacb3c-4ef3-4d72-bbf3-d6618e800002',
      genreId  : '69cacb3c-4ef3-4d72-bbf3-d6618e450001',
    });
    ...
    await Product.create({
      ...
      // brand: 1,
      categoryId : '62cacb3c-4ef3-4d72-bbf3-d6618e45a482',
      reviewsId  : '69cacb3c-4ef3-4d72-bbf3-d6618e800003',
      genreId   : '69cacb3c-4ef3-4d72-bbf3-d6618e450001',
    });
...
//       stock: 20,
//       description:
//         '100 % impermeables, se ajustan con pega pega\
